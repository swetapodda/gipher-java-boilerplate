...
import com.stackroute.gipherrecommendersystem.IConstants;
...
public class SwaggerConfiguration {
	...
	private Predicate<String> postPaths() {
    	return Predicates.or(PathSelectors.regex("/api/v1/gipherrecomendersystem.*"));
	}

	private ApiInfo apiInfo() {
	        ApiInfo apiInfo=new ApiInfoBuilder().title("Gipher Recomender Service")
				.description("Gipher Recomender Service API for Developers")
