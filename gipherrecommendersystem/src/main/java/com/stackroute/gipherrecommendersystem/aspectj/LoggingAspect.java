package com.stackroute.gipherrecommendersystem.aspectj;
...
public class LoggingAspect {
	...
	@Before(value="execution(* com.stackroute.gipherrecommendersystem.controller.*.*(..))")
	...
	@After(value="execution(* com.stackroute.gipherrecommendersystem.controller.*.*(..))")
	...
	@AfterReturning(value="execution(* com.stackroute.gipherrecommendersystem.controller.*.*(..))")
	...
	@AfterThrowing(pointcut="within(com.stackroute.gipherrecommendersystem.controller.*)", throwing="exceptinon")
