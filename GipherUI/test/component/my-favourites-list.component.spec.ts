...
describe('MyFavouritesListComponent', () => {
  let component: MyFavouritesListComponent;
  let fixture: ComponentFixture<MyFavouritesListComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(MyFavouritesListComponent);
